import { CLIENT_ACTION_TYPES } from "./trainer.types";
...
function userReducer(state = initialState, action) {
  ...
  switch (type) {
    ...
    case CLIENT_ACTION_TYPES.GET_CLIENTSLASTVISITED_SUCCESS:
      return {
        ...state,
    ...
    case CLIENT_ACTION_TYPES.GET_CLIENTSLASTVISITED_FAILED:
      return {
        ...state,
        clientsLastVisited: [],
        loading: false,
